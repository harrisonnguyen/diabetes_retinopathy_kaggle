...
def tfdata_generator(all_image_path, labels=None, is_training=False,buffer_size=300,batch_size=32,n_epochs=None,include_filename=False):
    ...
    if include_filename:
        dataset = tf.data.Dataset.zip((dataset, file_name))
    if is_training:
